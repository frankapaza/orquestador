...
function NewCampaignForm() {
  ...
  async function uploadRecipients(file) {
    ...
    try {
      ...
      const q = `?channel=${form.channel}&assistant_id=${assistantId}&name=${encodeURIComponent(form.name || 'Campaña')}`
                      ...
                      {recipientMode === 'list' ? (
                        ...
                        <>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Excel/CSV con columna <b>documento</b> (obligatoria) y {isEmail ? <>una de <b>correo</b> (email, correo…)</> : <>una de <b>teléfono</b> (telefono, celular, phone…)</>}. Se creará una lista automáticamente.
                          </p>
